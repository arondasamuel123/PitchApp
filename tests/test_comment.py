...
class CommentModalTest(unittest.TestCase):
    def setUp(self):
        ...
        self.user_sydo = User(username= 'mark', email='mark@gmail.com',password='xyz', profile_image='/photos/mark.png')
    ...
    def test_get_comment_by_pitch_id(self):
        self.new_comment.save_comment()
        get_comms = Comment.get_comments(self.new_comment.pitch)
